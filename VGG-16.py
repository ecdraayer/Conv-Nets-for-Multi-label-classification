...
for i, c in training_data.values:
    training_images += [cv2.resize(cv2.imread('Train/train-jpg/' + i + '.jpg'), (48, 48))]
...
for i, c in testing_data.values:
    if i.startswith('test'):
        testing_images += [cv2.resize(cv2.imread(os.getcwd() + '/Test/test-jpg/' + i + '.jpg'), (48, 48))]
    elif i.startswith('file'):
        testing_images += [cv2.resize(cv2.imread(os.getcwd() + '/Test/test-jpg-additional/' + i + '.jpg'), (48, 48))]
